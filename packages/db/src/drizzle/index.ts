...
export * as retentionRowsRepo from "./repositories/retention-rows";
export * as dsarRequestRepo from "./repositories/dsar-requests";
...
} from "./repositories/revenue-event-partitions";
