...
final class RovenueTests: XCTestCase {
    ...
    func test_getVersion_matchesCargoPkgVersion() throws {
        let cfg = Config(apiKey: "pk_test_xyz", debug: false, appVersion: nil, platform: nil, baseUrl: "https://api.rovenue.io")
    ...
    func test_invalidApiKey_throws_atGeneratedLayer() {
        let cfg = Config(apiKey: "", debug: false, appVersion: nil, platform: nil, baseUrl: "https://api.rovenue.io")
