...
private fun uniffiCheckApiChecksums(lib: _UniFFILib) {
    ...
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_claim_funnel_token() != 45728.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_claim_install() != 49258.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_claim_via_email() != 13981.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_flush_attributes() != 30176.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_flush_session_events() != 27023.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_get_offerings() != 13775.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_get_or_create_app_account_token() != 49766.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_identify() != 21224.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_install_id() != 43176.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_log_out() != 37523.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_post_apple_receipt() != 5520.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_post_google_receipt() != 33909.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_record_session_event() != 22164.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_refresh_entitlements() != 26843.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_refresh_remote_config() != 38655.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_refresh_virtual_currencies() != 62881.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_set_attributes() != 57836.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_rovenue_checksum_method_rovenuecore_track() != 7835.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_rovenue_checksum_constructor_rovenuecore_new() != 49054.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface RovenueCoreInterface {
    @Throws(RovenueErrorFfi::class)
    fun `claimFunnelToken`(`token`: String): FunnelClaimResult@Throws(RovenueErrorFfi::class)
    fun `claimInstall`(`params`: ClaimInstallParams): FunnelClaimResult?@Throws(RovenueErrorFfi::class)
    ...
    fun `experimentsAll`(): List<ExperimentAssignment>@Throws(RovenueErrorFfi::class)
    fun `flushAttributes`(): UInt@Throws(RovenueErrorFfi::class)
    fun `flushSessionEvents`(): UInt@Throws(RovenueErrorFfi::class)
    fun `getOfferings`(): CoreOfferings@Throws(RovenueErrorFfi::class)
    fun `getOrCreateAppAccountToken`(): String
    fun `getVersion`(): String
    fun `hasResolvedFunnelClaim`(): Boolean@Throws(RovenueErrorFfi::class)
    fun `identify`(`appUserId`: String)
    fun `installId`(): String@Throws(RovenueErrorFfi::class)
    fun `logOut`()@Throws(RovenueErrorFfi::class)
    fun `postAppleReceipt`(`receipt`: String, `productId`: String, `appAccountToken`: String?): ReceiptResult@Throws(RovenueErrorFfi::class)
    fun `postGoogleReceipt`(`receipt`: String, `productId`: String, `obfuscatedAccountId`: String?, `obfuscatedProfileId`: String?): ReceiptResult@Throws(RovenueErrorFfi::class)
    fun `recordSessionEvent`(`kind`: SessionEventKind, `occurredAt`: String, `durationMs`: UInt?)@Throws(RovenueErrorFfi::class)
    fun `refreshEntitlements`()@Throws(RovenueErrorFfi::class)
    fun `refreshRemoteConfig`()@Throws(RovenueErrorFfi::class)
    ...
    fun `remoteConfigString`(`key`: String, `fallback`: String): String@Throws(RovenueErrorFfi::class)
    fun `setAttributes`(`attributes`: Map<String, String?>)
    fun `setForeground`(`foreground`: Boolean)
    fun `shutdown`()@Throws(RovenueErrorFfi::class)
...
class RovenueCore(
    ...
    constructor(`config`: Config) :
        this(
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `claimFunnelToken`(`token`: String): FunnelClaimResult =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `claimInstall`(`params`: ClaimInstallParams): FunnelClaimResult? =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `claimViaEmail`(`email`: String) =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `flushAttributes`(): UInt =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `flushSessionEvents`(): UInt =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `getOfferings`(): CoreOfferings =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `getOrCreateAppAccountToken`(): String =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `identify`(`appUserId`: String) =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `logOut`() =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `postAppleReceipt`(`receipt`: String, `productId`: String, `appAccountToken`: String?): ReceiptResult =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `postGoogleReceipt`(`receipt`: String, `productId`: String, `obfuscatedAccountId`: String?, `obfuscatedProfileId`: String?): ReceiptResult =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `recordSessionEvent`(`kind`: SessionEventKind, `occurredAt`: String, `durationMs`: UInt?) =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `refreshEntitlements`() =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `refreshRemoteConfig`() =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `refreshVirtualCurrencies`() =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `setAttributes`(`attributes`: Map<String, String?>) =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
    ...
    @Throws(RovenueErrorFfi::class)override fun `track`(`envelopeJson`: String) =
        callWithPointer {
    rustCallWithError(RovenueErrorFfi) { _status ->
...
enum class ErrorKind {
    NETWORK_UNAVAILABLE,TIMEOUT,RATE_LIMITED,SERVER_ERROR,INVALID_API_KEY,FORBIDDEN,NOT_FOUND,INVALID_REQUEST,CONFLICT,INVALID_ARGUMENT,INSUFFICIENT_CREDITS,FUNNEL_TOKEN_NOT_FOUND,FUNNEL_TOKEN_EXPIRED,FUNNEL_TOKEN_ALREADY_CLAIMED,PURCHASE_CANCELED,PRODUCT_NOT_AVAILABLE,ALREADY_OWNED,PAYMENT_DECLINED,STORE_SERVICE_UNAVAILABLE,INELIGIBLE,RECEIPT_INVALID,STORE_PROBLEM,STORAGE,INTERNAL;
    companion object
}
...
public object FfiConverterTypeErrorKind: FfiConverterRustBuffer<ErrorKind> {
    ...
    override fun allocationSize(value: ErrorKind) = 4
...
sealed class RovenueErrorFfi: Exception() {
    ...
    class Generic(
        ...
        val `httpStatus`: UShort?,
        val `retryable`: Boolean
        ) : RovenueErrorFfi() {
        override val message: String
            get() = "kind=${ `kind` }, message=${ `errorMessage` }, serverCode=${ `serverCode` }, httpStatus=${ `httpStatus` }, retryable=${ `retryable` }"
    }
    

    companion object ErrorHandler : CallStatusErrorHandler<RovenueErrorFfi> {
        override fun lift(error_buf: RustBuffer.ByValue): RovenueErrorFfi = FfiConverterTypeRovenueErrorFfi.lift(error_buf)
    }

    
}

public object FfiConverterTypeRovenueErrorFfi : FfiConverterRustBuffer<RovenueErrorFfi> {
    override fun read(buf: ByteBuffer): RovenueErrorFfi {
        

        return when(buf.getInt()) {
            1 -> RovenueErrorFfi.Generic(
    ...
    override fun allocationSize(value: RovenueErrorFfi): Int {
        return when(value) {
            is RovenueErrorFfi.Generic -> (
                // Add the size for the Int that specifies the variant plus the size needed for all fields
                4
                + FfiConverterTypeErrorKind.allocationSize(value.`kind`)
                + FfiConverterString.allocationSize(value.`errorMessage`)
                + FfiConverterOptionalString.allocationSize(value.`serverCode`)
                + FfiConverterOptionalUShort.allocationSize(value.`httpStatus`)
                + FfiConverterBoolean.allocationSize(value.`retryable`)
            )
        }
    }

    override fun write(value: RovenueErrorFfi, buf: ByteBuffer) {
        when(value) {
            is RovenueErrorFfi.Generic -> {
                buf.putInt(1)
                FfiConverterTypeErrorKind.write(value.`kind`, buf)
                FfiConverterString.write(value.`errorMessage`, buf)
                FfiConverterOptionalString.write(value.`serverCode`, buf)
                FfiConverterOptionalUShort.write(value.`httpStatus`, buf)
