...
// Mirrors packages/shared/src/paywall/visibility.test.ts verbatim
// (including every FAILS OPEN case) — the RN evaluator must agree with
// the shared implementation and the Swift/Kotlin siblings exactly.
