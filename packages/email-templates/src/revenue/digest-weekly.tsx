...
import type { DigestDailyProjectSection } from "./digest-daily";

export interface DigestWeeklyCtx {
  weekStart: string;
  weekEnd: string;
  timezone: string;
...
const NS = "revenue.digest-weekly";
...
function Email({ ctx, t }: { ctx: DigestWeeklyCtx; t: TFunction }) {
...
export const template: TemplateModule<DigestWeeklyCtx> = {
  Component: Email,
  subject: (ctx, t) =>
