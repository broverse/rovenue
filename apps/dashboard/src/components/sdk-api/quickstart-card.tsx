  ...
  return (
    <section className="mb-4 rounded-lg border border-rv-divider bg-rv-c1">
      <header className="flex flex-wrap items-start justify-between gap-3 border-b border-rv-divider px-4 py-4 sm:px-5">
        ...
        <div
          className="-mb-px inline-flex max-w-full flex-wrap items-center gap-1 overflow-x-auto rounded-md border border-rv-divider bg-rv-c2 p-0.5"
          role="tablist"
          ...
          {PLATFORMS.map((option) => {
            ...
            return (
              <button
                ...
                className={cn(
                  "inline-flex h-7 shrink-0 cursor-pointer items-center rounded px-2.5 text-[12px] transition",
                  selected
      ...
      <div className="grid items-start gap-4 px-4 py-4 sm:px-5 sm:py-5 lg:grid-cols-2">
        <div>
