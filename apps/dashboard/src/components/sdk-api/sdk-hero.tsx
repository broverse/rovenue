...
export function SdkHero({ stats }: Props) {
  ...
  return (
    <div
      style={heroStyle}
      className="mb-4 grid items-center gap-6 rounded-[10px] border border-rv-divider px-7 py-6 grid-cols-1 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]"
    >
        ...
        <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-4">
          {tiles.map((tile) => (
            <div key={tile.labelKey}>
              ...
              <div className="mt-1 font-rv-mono text-[20px] font-medium leading-none text-foreground">
                {tile.value}
                {tile.unit ? (
