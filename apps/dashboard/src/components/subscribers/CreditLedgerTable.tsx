      ...
      <table className="w-full text-sm">
        <thead className="text-left text-xs uppercase text-default-500">
          <tr className="border-b border-default-200">
            <th className="py-2 pr-4">{t("subscribers.credit.when")}</th>
            <th className="py-2 pr-4">{t("subscribers.credit.type")}</th>
            <th className="py-2 pr-4">{t("subscribers.credit.amount")}</th>
            <th className="py-2 pr-4">{t("subscribers.credit.balance")}</th>
            <th className="py-2">{t("subscribers.credit.note")}</th>
          </tr>
        </thead>
        <tbody>
          {rows.map((r) => (
