...
const EVENT_KEYS_BY_PROVIDER: Record<IntegrationProviderId, readonly string[]> = {
  ...
  // BRAZE (Wave-2 Task 4) offers the same 13-key standard catalog every
  // analytics/attribution/lifecycle provider does — its `eventCatalog`
  // (providers/braze.ts) is literally STANDARD_PROVIDER_EVENT_KEYS.
