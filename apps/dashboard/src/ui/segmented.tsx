...
export const segmentedItemVariants = cva(
  "inline-flex h-6 flex-1 cursor-pointer items-center justify-center rounded px-2.5 text-xs font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rv-accent-500 focus-visible:ring-offset-1 focus-visible:ring-offset-rv-c2 data-[checked]:bg-rv-c4 data-[checked]:text-foreground text-rv-mute-600 hover:text-foreground",
  {
    variants: {
